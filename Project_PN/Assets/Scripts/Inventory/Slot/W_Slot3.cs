...
public class W_Slot3 : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    [Header("아이템 정보 표시 UI")]
    ...
    public static Action W3_ReloadInfoData;

    public static Action W3_ReloadData;

    public static Action W3_ReloadID;
    ...
    private void Awake()
    {
        W3_ReloadInfoData = () => { InfoReload(); };

        W3_ReloadData = () => { DataReload(); };
